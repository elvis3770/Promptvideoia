...
const ImageToVideo = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            ...
            const res = await api.imageToVideo(formData);
            if (res.data.ok) {
                const newJob = {
    ...
    return (
        <div>
            <div className="mb-8">
                <h1 className="text-2xl font-bold text-slate-900">Image → Video</h1>
                <p className="text-slate-500">Bring your static images to life.</p>
            </div>
